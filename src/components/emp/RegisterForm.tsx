...
const RegisterForm = () => {
    ...
    <form onSubmit={onSubmit}>
      <input name="empno" placeholder="직원번호" onChange={onChange} value={form.empno} />
      <br />
      <input name="ename" placeholder="직원이름" onChange={onChange} value={form.ename} />
      <br />
      <input name="mgr" placeholder="직원상사" onChange={onChange} value={form.mgr} />
      <br />
      <input name="hiredate" placeholder="입사일" onChange={onChange} value={form.hiredate} />
      <br />
      <input name="job" placeholder="직업" onChange={onChange} value={form.job} />
      <br />
      <input name="sal" placeholder="급여" onChange={onChange} value={form.sal} />
      <br />
      <input name="comm" placeholder="커미션" onChange={onChange} value={form.comm} />
      <br />
